import type { UseCaseDetailPage } from "@/lib/use-case-types";
...
export const useCaseDetailPages: UseCaseDetailPage[] = [
  {
    ...
    intro:
      "Use Neroa when planning work needs more than a draft. Neroa can frame the business direction, Atlas can deepen the research context, and the workspace can keep strategy, notes, writing, and next moves connected.",
    summary:
    ...
    workflow: [
      {
        ...
        description:
          "Start with the offer, market, customer, or operating decision Neroa needs to clarify first.",
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa holds the planning flow together and turns the work into a usable operating direction."
      },
      {
        id: "atlas",
        badge: "Research",
  ...
  },
  {
    ...
    intro:
      "Neroa helps founders and product teams move from SaaS idea to structured execution. Neroa frames the product, Atlas helps validate demand, Forge shapes the build logic, and the workspace keeps MVP, budget, and launch decisions connected.",
    summary:
    ...
    workflow: [
      {
        ...
        description:
          "Use Neroa and Atlas to define the problem, customer, and the first useful MVP boundary."
      },
      {
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa frames the SaaS idea, keeps the MVP focused, and routes the work into the right build sequence."
      },
      {
        id: "atlas",
        badge: "Validation",
  ...
  },
  {
    ...
    workflow: [
      ...
      },
      {
        ...
        description:
          "Use Neroa, Atlas, and Forge to shape requirements, dashboards, permissions, and implementation order."
      },
      {
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa frames the internal system around the real workflow and keeps the build tied to the operating need."
      },
      {
        id: "forge",
        badge: "Build",
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa frames the product direction, customer experience, and next execution moves."
      },
      {
        id: "nova",
        badge: "Experience",
  ...
  },
  {
    ...
    intro:
      "Use Neroa when the product is truly mobile-first. Neroa frames the app, Forge shapes the React Native + Expo build path, Atlas helps validate the product logic, RepoLink supports the implementation layer, and Ops keeps launch and release work operationally grounded.",
    summary:
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa holds the mobile product direction, stack logic, and execution sequence together."
      },
      {
        id: "forge",
        badge: "Build",
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa orchestrates the project and keeps technical, strategic, and launch decisions coherent."
      },
      {
        id: "atlas",
        badge: "Context",
  ...
  },
  {
    ...
    workflow: [
      ...
      },
      {
        ...
        description:
          "Let Neroa and Ops draft process notes, checklists, and repeatable sequences."
      },
      {
    ...
    collaboration: [
      {
        id: "narua",
        badge: "Core",
        description: "Neroa frames the operating context and keeps the lane focused on useful execution output."
      },
      {
        id: "ops",
        badge: "Workflow",
