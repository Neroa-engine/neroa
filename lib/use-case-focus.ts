...
export const useCaseFocusPages: UseCaseFocusPage[] = [
  {
    ...
    whatNeroaDoes: [
      "Naroa interprets the business objective and narrows it into a usable planning question.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      "Naroa keeps the research tied to the actual business objective instead of turning it into endless exploration.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      "Naroa keeps the business plan coherent and moves the writing in the right sequence.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      "Naroa adapts the same business logic into the right output format for the audience.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      "Naroa helps define the offer, customer, and first operating model with less noise.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      "Naroa keeps the research connected to the current planning question.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      "Naroa turns the planning thread into memos, briefs, and summaries that support action.",
  ...
  },
  {
    ...
    whatNeroaDoes: [
      ...
      "Naroa keeps those outputs connected to the strategy and business question that shaped them.",
