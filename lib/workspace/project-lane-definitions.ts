...
export const projectLanePhaseOrder: ProjectLanePhaseId[] = [
  "strategy",
  "build",
  "budget",
  "launch",
...
export const projectLanePhaseRegistry: Record<ProjectLanePhaseId, ProjectLanePhaseDefinition> = {
  strategy: {
    id: "strategy",
    label: "Strategy Lane",
...
export const projectTemplateRegistry: Record<ProjectTemplateId, ProjectTemplateDefinition> = {
  "business-launch": {
    id: "business-launch",
    ...
    lanes: [
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Strategy brief", "Offer logic"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Business plan", "Roadmap"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Budget model", "Cost planning"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Naming shortlist", "Domain setup"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Brand narrative", "Voice system"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Site map", "Copy system", "Launch site"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Workflow map", "SOPs"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Marketing plan", "Campaign map"],
        starterPrompts: [
    ...
    lanes: [
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Requirements brief", "Acceptance criteria"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Architecture notes", "Dependency map"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Implementation plan", "Task list"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Test plan", "Regression checks"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Release checklist", "Deployment notes"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Docs outline", "Onboarding notes"],
        starterPrompts: [
    ...
    lanes: [
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Brand strategy", "Positioning"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Catalog plan", "Product priorities"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Storefront plan", "Conversion path"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Identity direction", "Voice system"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Ops plan", "Fulfillment map"],
        starterPrompts: [
      ...
      },
      {
        ...
        recommendedAIStack: ["Neroa Execution Layer", "Launch marketing", "Channel plan"],
        starterPrompts: [
