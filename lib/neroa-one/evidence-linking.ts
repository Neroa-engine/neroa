...
export const neroaOneEvidenceLinkingLaneDefinitionSchema = z
  .object({
    ...
    createsAuditEventsNow: z.literal(false),
    classifiesAuditSeverityNow: z.literal(false),
    recommendsAdminActionNow: z.literal(false),
    detectsStuckWorkNow: z.literal(false),
    detectsRetryLoopsNow: z.literal(false),
    detectsCostWasteNow: z.literal(false),
    detectsPolicyViolationsNow: z.literal(false),
...
export const neroaOneEvidenceLinkingLane = neroaOneEvidenceLinkingLaneDefinitionSchema.parse({
  ...
  createsAuditEventsNow: false,
  classifiesAuditSeverityNow: false,
  recommendsAdminActionNow: false,
  detectsStuckWorkNow: false,
  detectsRetryLoopsNow: false,
  detectsCostWasteNow: false,
  detectsPolicyViolationsNow: false,
