        ...
        <section className="grid gap-6 xl:grid-cols-[1.04fr_0.96fr]">
          <div className="floating-plane rounded-[32px] p-6 sm:p-7">
            ...
            <div className="relative">
              ...
              <div className="mt-6 rounded-[24px] border border-[color:var(--front-door-border)] bg-[linear-gradient(140deg,rgba(11,18,33,0.96),rgba(8,11,24,0.96))] px-5 py-4 shadow-[0_18px_42px_rgba(7,10,20,0.32),0_0_0_1px_rgba(112,211,252,0.1)]">
                <PortalSummaryRow
