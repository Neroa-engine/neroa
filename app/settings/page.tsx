      ...
      <div className="space-y-6">
        <section className="floating-plane relative overflow-hidden rounded-[34px] px-6 py-8 xl:px-8">
          ...
          <div className="relative flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div className="rounded-[22px] border border-slate-200/70 bg-white/84 px-5 py-5">
        ...
        <section className="grid gap-6 xl:grid-cols-[1.08fr_0.92fr]">
          ...
          <div className="floating-plane rounded-[28px] p-5 sm:p-6">
            ...
            <div className="relative">
              ...
              <div className="mt-5 rounded-[20px] border border-slate-200/70 bg-white/82 px-5 py-4">
                <PortalSummaryRow
                  label="Current plan"
