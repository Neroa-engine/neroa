    ...
    <div className="space-y-6">
      <section className="rounded-[32px] border border-white/8 bg-white/[0.03] p-6 xl:p-8">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300 xl:text-base xl:leading-8">
          This route intentionally excludes Neroa so advertising-only modeling can run as a focused surface without the persistent build guidance layer in view.
        </p>
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        ...
        <div className="rounded-[28px] border border-white/8 bg-white/[0.03] p-6">
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">Why Neroa is excluded here</p>
          <p className="mt-3 text-sm leading-7 text-slate-200">
