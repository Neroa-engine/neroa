      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="absolute right-0 top-[calc(100%+0.8rem)] w-[min(88vw,320px)] rounded-[28px] border border-slate-200/80 bg-white/90 p-4 shadow-[0_24px_72px_rgba(15,23,42,0.16)] backdrop-blur-2xl"
          >
