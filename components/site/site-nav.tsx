                      ...
                      <div className="relative flex min-h-0 flex-1 flex-col">
                        ...
                        <div className="grid gap-3 pb-1">
                            {siteNavItems.map((item, index) => {
                              ...
                              const cardClassName =
                                "micro-glow rounded-[24px] border border-slate-200/75 bg-white/72 px-4 py-4 transition hover:border-cyan-300/45 hover:bg-white/92 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/45";
                                ...
                                return (
                                  ...
                                  >
                                    <div className="flex items-center justify-between gap-3">
                                      ...
                                      <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200/80 bg-white/84 text-cyan-700">
                                        <ArrowIcon />
