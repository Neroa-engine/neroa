...
export function CommandCenterBrowserRuntimePanel({
  ...
  const buttonClasses =
    presentation === "chat"
      ? "rounded-full border border-[rgba(167,136,250,0.68)] bg-[linear-gradient(135deg,#8f7cff,#a788fa_56%,#c19cff)] px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.14em] text-white shadow-[0_18px_40px_rgba(148,122,255,0.34)] transition hover:brightness-[1.06] disabled:cursor-wait disabled:border-white/10 disabled:bg-white/10 disabled:text-slate-400 disabled:shadow-none"
