...
export function CommandCenterPopoverBar({
  ...
  const summaryToneClasses =
    tone === "dark"
      ? "border-[rgba(166,212,255,0.18)] bg-[linear-gradient(180deg,rgba(12,21,35,0.94),rgba(8,14,24,0.9))] text-white shadow-[0_22px_50px_rgba(2,6,23,0.34)]"
      : "border-slate-200/70 bg-white/88 text-slate-950 shadow-[0_18px_40px_rgba(15,23,42,0.08)]";

  const bubbleToneClasses =
    tone === "dark"
      ? "border-[rgba(136,168,207,0.18)] bg-[linear-gradient(180deg,rgba(9,15,27,0.98),rgba(6,10,18,0.96))] text-slate-100 ring-1 ring-[rgba(112,211,252,0.08)] shadow-[0_36px_96px_rgba(2,6,23,0.6)]"
            ...
            <div className="pointer-events-none fixed inset-0 z-[160]">
              <div
                ...
                className={`pointer-events-auto fixed w-[min(34rem,calc(100vw-2.5rem))] rounded-[24px] border p-4 ${
                  bubbleToneClasses
                } ${tone === "dark" ? "front-door-scope" : ""} ${bubbleLayout?.ready ? "visible" : "invisible"} ${bubbleClassName}`}
              >
                <button
                  type="button"
                  ...
                  className={`absolute right-3 top-3 rounded-full border px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] transition ${
                    tone === "dark"
                      ? "border-[rgba(166,212,255,0.18)] bg-[rgba(10,18,31,0.92)] text-slate-100 hover:bg-[rgba(14,24,39,0.98)]"
