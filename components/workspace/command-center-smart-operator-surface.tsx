            ...
            return (
              <button
                ...
                className={`rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] transition ${
                  active
                    ? "border-sky-300/65 bg-[linear-gradient(135deg,#38bdf8,#4f46e5)] text-white shadow-[0_14px_32px_rgba(59,130,246,0.28)]"
              ...
              <form action={createTaskAction} className="space-y-3">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                  ...
                  <button
                    ...
                    className="rounded-full border border-sky-300/70 bg-[linear-gradient(135deg,#38bdf8,#4f46e5)] px-4 py-3 text-xs font-semibold uppercase tracking-[0.14em] text-white shadow-[0_18px_40px_rgba(59,130,246,0.3)] transition hover:brightness-[1.06] disabled:cursor-not-allowed disabled:border-white/10 disabled:bg-white/10 disabled:text-slate-400 disabled:shadow-none"
                  >
